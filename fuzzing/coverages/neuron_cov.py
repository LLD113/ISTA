...
import numpy as np
from fuzzing.coverages.utils import get_layer_outs_new, percent_str, percent
...
# 继承自 coverage.py 中的基类，重写了基类中的部分方法
class NeuronCoverage(AbstractCoverage):
    def __init__(self, model, scaler=default_scale, threshold=0.75, skip_layers=None, calc_implicit_reward_neuron=None,
    ...
    def get_current_coverage(self, with_implicit_reward=False):
        ...
        reward, covered, implicit_reward = self.calc_reward(self.activation_table,
                                                            with_implicit_reward=with_implicit_reward)
