import random
import numpy as np
from fuzzing.src.utility import init_image_plots, update_image_plots
...
class Tensorfuzz:
    ...
    def do_basic_mutations(self, corpus_element, mutations_count):
        ...
        mutated_image_batch = np.clip(mutated_image_batch, a_min=self.params.input_lower_limit,
                                      a_max=self.params.input_upper_limit)
